...
func Header(isAuth bool) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if isAuth {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 2, "<span hx-get=\"/home\" hx-trigger=\"click\" hx-target=\"#page\" hx-swap=\"outerHTML\" style=\"cursor: pointer;\">ClubManager</span> <span hx-get=\"/\" hx-trigger=\"click\" hx-target=\"#page\" hx-swap=\"outerHTML\" style=\"cursor: pointer;\">Deconnexion</span>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		} else {
